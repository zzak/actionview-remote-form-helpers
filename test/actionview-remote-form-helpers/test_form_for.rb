...
class FormForHelperTest < ActionViewRemoteFormHelpersTestCase
  ...
  def form_text(action = "/", id = nil, html_class = nil, remote = nil, method = nil)
  ...
  def whole_form(action = "/", id = nil, html_class = nil, options = {})
    ...
    form_text(action, id, html_class, remote, method) + hidden_fields(options.slice :method, :enforce_utf8) + contents + "</form>"
  end
