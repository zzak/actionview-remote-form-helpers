    ...
    initializer "actionview_remote_forms_helper.action_view" do
      ActiveSupport.on_load(:action_view) do
        ...
        unless ActionView::Helpers::FormHelper.respond_to?(:form_with_generates_remote_forms)
          ...
          ActionView::Helpers::FormHelper.form_with_generates_remote_forms = Rails.application.config.action_view.delete(:form_with_generates_remote_forms)
        end

        automatically_disable_submit_tag = Rails.application.config.action_view.delete(:automatically_disable_submit_tag)
        ActionView::Base.automatically_disable_submit_tag = automatically_disable_submit_tag
